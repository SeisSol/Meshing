...
/*
BedrockVelModel(1,:) = (/  -6d3, 2550d0,18589500000d0,26571000000d0/) => 5000
m/s BedrockVelModel(2,:) = (/  -8d3, 2850d0,39016500000d0,42379500000d0/) =>
6500 m/s BedrockVelModel(3,:) = (/ -12d3, 3050d0,50027625000d0,53695250000d0/)
=> 7100 m/s BedrockVelModel(4,:) = (/-6d3,2720d0,33320000000d0,31280000000d0/)
