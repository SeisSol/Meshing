...
parser.add_argument("--N", nargs=1, metavar=("N"), type=int, default=0, help="number of initial refine steps")
parser.add_argument("--P", nargs=1, metavar=("P"), type=int, default=1, help="number of and refine/smoothing steps")
