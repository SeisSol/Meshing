 ...
 <Domain>
  <Grid Name="TimeSeries" GridType="Collection" CollectionType="Temporal">
   <Grid Name="step_000000000000" GridType="Uniform"><!-- mesh id: 0, mesh step: 0 -->
    ...
    </Attribute>""" % (dataName, ntriangles, ntriangles, ntriangles, fn,
                       dataName)
...
parser = argparse.ArgumentParser(
    description=
    'Read hdf5 mesh and create a xdmf/h5 file containing the BC surfaces')
parser.add_argument(
    'filename',
    help='fault output filename (xdmf), or SeisSol netcdf (nc) or ts (Gocad)')
parser.add_argument(
    'BC', help='1: free surface, 3:dynamic rupture 5:absorbing 0:all')
